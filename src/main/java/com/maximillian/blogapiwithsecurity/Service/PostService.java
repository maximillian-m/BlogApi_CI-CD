...
public interface PostService {
     PostsDto createPost(PostsDto postsDto, Long id) throws CustomException;
     List<PostsDto> displayAllPost();

     void deletePost(PostsDto postsDto, Long adminId) throws CustomException;

     void editPost(PostsDto postsDto, Long adminId) throws CustomException;
